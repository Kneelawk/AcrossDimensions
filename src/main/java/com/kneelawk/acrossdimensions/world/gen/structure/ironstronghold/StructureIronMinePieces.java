...
public class StructureIronMinePieces {
	/** List of contents that can generate in Iron Mines. */
	public static final WeightedRandomChestContent[] ironMineChestContents = new WeightedRandomChestContent[] {
	...
	public static void registerStructurePieces() {
		MapGenStructureIO.func_143031_a(StructureIronMinePieces.Corridor.class,
				"IMCorridor");
		MapGenStructureIO.func_143031_a(StructureIronMinePieces.Cross.class,
				"IMCrossing");
		MapGenStructureIO.func_143031_a(StructureIronMinePieces.Room.class,
				"IMRoom");
		MapGenStructureIO.func_143031_a(StructureIronMinePieces.Stairs.class,
				"IMStairs");
	}
	...
	private static StructureComponent getRandomComponent(List p_78815_0_,
		...
		if (j1 >= 80) {
			structureboundingbox = StructureIronMinePieces.Cross
					.findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_,
							p_78815_3_, p_78815_4_, p_78815_5_);

			if (structureboundingbox != null) {
				return new StructureIronMinePieces.Cross(p_78815_6_,
						p_78815_1_, structureboundingbox, p_78815_5_);
			}
		} else if (j1 >= 70) {
			structureboundingbox = StructureIronMinePieces.Stairs
					.findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_,
							p_78815_3_, p_78815_4_, p_78815_5_);

			if (structureboundingbox != null) {
				return new StructureIronMinePieces.Stairs(p_78815_6_,
						p_78815_1_, structureboundingbox, p_78815_5_);
			}
		} else {
			structureboundingbox = StructureIronMinePieces.Corridor
					.findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_,
							p_78815_3_, p_78815_4_, p_78815_5_);

			if (structureboundingbox != null) {
				return new StructureIronMinePieces.Corridor(p_78815_6_,
						p_78815_1_, structureboundingbox, p_78815_5_);
			}
		}
	...
	private static StructureComponent getNextIronMineComponent(
		...
		if (p_78817_7_ > 8) {
			...
			StructureComponent structurecomponent1 = getRandomComponent(
					p_78817_1_, p_78817_2_, p_78817_3_, p_78817_4_, p_78817_5_,
					p_78817_6_, p_78817_7_ + 1);

			if (structurecomponent1 != null) {
				p_78817_1_.add(structurecomponent1);
				structurecomponent1.buildComponent(p_78817_0_, p_78817_1_,
						p_78817_2_);
			}
	...
	public static class Corridor extends StructureComponent {
		...
		public Corridor(int p_i2035_1_, Random p_i2035_2_,
			...
			this.hasRails = p_i2035_2_.nextInt(4) != 0;
		...
		public static StructureBoundingBox findValidPlacement(List p_74954_0_,
			...
			for (i1 = p_74954_1_.nextInt(3) + 2; i1 > 0; --i1) {
				...
				if (StructureComponent.findIntersecting(p_74954_0_,
			...
			case 1:
				if (j <= 1) {
					StructureIronMinePieces.getNextIronMineComponent(
							...
							this.boundingBox.minX - 1, this.boundingBox.minY
									- 1 + p_74861_3_.nextInt(3),
							this.boundingBox.minZ, this.coordBaseMode, i);
				} else if (j == 2) {
					StructureIronMinePieces.getNextIronMineComponent(
							p_74861_1_, p_74861_2_, p_74861_3_,
							this.boundingBox.minX, this.boundingBox.minY - 1
			...
			case 2:
				if (j <= 1) {
					StructureIronMinePieces.getNextIronMineComponent(
							...
							this.boundingBox.minX, this.boundingBox.minY - 1
									+ p_74861_3_.nextInt(3),
							this.boundingBox.minZ - 1, this.coordBaseMode, i);
				} else if (j == 2) {
					StructureIronMinePieces.getNextIronMineComponent(
							p_74861_1_, p_74861_2_, p_74861_3_,
							this.boundingBox.minX - 1, this.boundingBox.minY
									- 1 + p_74861_3_.nextInt(3),
							this.boundingBox.minZ, 1, i);
				} else {
					StructureIronMinePieces.getNextIronMineComponent(
							p_74861_1_, p_74861_2_, p_74861_3_,
							this.boundingBox.maxX + 1, this.boundingBox.minY
									- 1 + p_74861_3_.nextInt(3),
							this.boundingBox.minZ, 3, i);
				}
			...
			if (i < 8) {
				...
				if (this.coordBaseMode != 2 && this.coordBaseMode != 0) {
					for (k = this.boundingBox.minX + 3; k + 3 <= this.boundingBox.maxX; k += 5) {
						...
						if (l == 0) {
							StructureIronMinePieces.getNextIronMineComponent(
									p_74861_1_, p_74861_2_, p_74861_3_, k,
		...
		protected boolean generateStructureChestContents(World p_74879_1_,
			...
			if (p_74879_2_.isVecInside(i1, j1, k1)
					&& p_74879_1_.getBlock(i1, j1, k1).getMaterial() == Material.air) {
				int l1 = p_74879_3_.nextBoolean() ? 1 : 0;
				p_74879_1_.setBlock(i1, j1, k1, Blocks.rail,
						this.getMetadataWithOffset(Blocks.rail, l1), 2);
				EntityMinecartChest entityminecartchest = new EntityMinecartChest(
						p_74879_1_, (double) ((float) i1 + 0.5F),
						(double) ((float) j1 + 0.5F),
						(double) ((float) k1 + 0.5F));
				WeightedRandomChestContent.generateChestContents(p_74879_3_,
						p_74879_7_, entityminecartchest, p_74879_8_);
		...
		public boolean addComponentParts(World p_74875_1_, Random p_74875_2_,
			...
			if (this.isLiquidInStructureBoundingBox(p_74875_1_, p_74875_3_)) {
				...
				this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 0, 0, 2, 1, i,
						Blocks.air, Blocks.air, false);
				this.randomlyFillWithBlocks(p_74875_1_, p_74875_3_, p_74875_2_,
						0.8F, 0, 2, 0, 2, 2, i, Blocks.air, Blocks.air, false);

				if (this.hasSpiders) {
					this.randomlyFillWithBlocks(p_74875_1_, p_74875_3_,
							p_74875_2_, 0.6F, 0, 0, 0, 2, 1, i, Blocks.web,
							Blocks.air, false);
				}
				...
				for (j = 0; j < this.sectionCount; ++j) {
					k = 2 + j * 5;
					this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 0, k, 0, 1,
							k, Blocks.cobblestone_wall, Blocks.air, false);
					this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 0, k, 2, 1,
							k, Blocks.cobblestone_wall, Blocks.air, false);

					if (p_74875_2_.nextInt(4) == 0) {
						this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 2, k, 0,
								2, k, Blocks.iron_block, Blocks.air, false);
						this.fillWithBlocks(p_74875_1_, p_74875_3_, 2, 2, k, 2,
								2, k, Blocks.iron_block, Blocks.air, false);
					} else {
						this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 2, k, 2,
								2, k, Blocks.iron_block, Blocks.air, false);
					}

					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.1F, 0, 2, k - 1, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.1F, 2, 2, k - 1, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.1F, 0, 2, k + 1, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.1F, 2, 2, k + 1, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.05F, 0, 2, k - 2, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.05F, 2, 2, k - 2, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.05F, 0, 2, k + 2, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.05F, 2, 2, k + 2, Blocks.web, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.05F, 1, 2, k - 1, Blocks.torch, 0);
					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.05F, 1, 2, k + 1, Blocks.torch, 0);

					ChestGenHooks info = ChestGenHooks
							.getInfo(MINESHAFT_CORRIDOR);
					if (p_74875_2_.nextInt(100) == 0) {
						this.generateStructureChestContents(p_74875_1_,
								p_74875_3_, p_74875_2_, 2, 0, k - 1,
								info.getItems(p_74875_2_),
								info.getCount(p_74875_2_));
					}

					if (p_74875_2_.nextInt(100) == 0) {
						this.generateStructureChestContents(p_74875_1_,
								p_74875_3_, p_74875_2_, 0, 0, k + 1,
								info.getItems(p_74875_2_),
								info.getCount(p_74875_2_));
					}
					...
					if (this.hasSpiders && !this.spawnerPlaced) {
						...
						if (p_74875_3_.isVecInside(j1, l, i1)) {
							...
							p_74875_1_.setBlock(j1, l, i1, Blocks.mob_spawner,
									0, 2);
				...
				for (j = 0; j <= 2; ++j) {
					for (k = 0; k <= i; ++k) {
						byte b0 = -1;
						Block block1 = this.getBlockAtCurrentPosition(
								p_74875_1_, j, b0, k, p_74875_3_);

						if (block1.getMaterial() == Material.air) {
							byte b1 = -1;
							this.placeBlockAtCurrentPosition(p_74875_1_,
									Blocks.obsidian, 0, j, b1, k, p_74875_3_);
						}
					}
				}
				...
				if (this.hasRails) {
					for (j = 0; j <= i; ++j) {
						Block block = this.getBlockAtCurrentPosition(
								p_74875_1_, 1, -1, j, p_74875_3_);

						if (block.getMaterial() != Material.air
								&& block.func_149730_j()) {
							this.func_151552_a(p_74875_1_, p_74875_3_,
									p_74875_2_, 0.7F, 1, 0, j, Blocks.rail,
									this.getMetadataWithOffset(Blocks.rail, 0));
						}
					}
				}
	...
	public static class Cross extends StructureComponent {
		...
		public static StructureBoundingBox findValidPlacement(List p_74951_0_,
			...
			return StructureComponent.findIntersecting(p_74951_0_,
					structureboundingbox) != null ? null : structureboundingbox;
		}
		...
		public void buildComponent(StructureComponent p_74861_1_,
			...
			case 0:
				StructureIronMinePieces.getNextIronMineComponent(p_74861_1_,
						p_74861_2_, p_74861_3_, this.boundingBox.minX + 1,
						this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
				StructureIronMinePieces.getNextIronMineComponent(p_74861_1_,
						p_74861_2_, p_74861_3_, this.boundingBox.minX - 1,
						this.boundingBox.minY, this.boundingBox.minZ + 1, 1, i);
				StructureIronMinePieces.getNextIronMineComponent(p_74861_1_,
						p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1,
		...
		public boolean addComponentParts(World p_74875_1_, Random p_74875_2_,
			...
			if (this.isLiquidInStructureBoundingBox(p_74875_1_, p_74875_3_)) {
				...
				if (this.isMultipleFloors) {
					this.fillWithBlocks(p_74875_1_, p_74875_3_,
							this.boundingBox.minX + 1, this.boundingBox.minY,
				...
				this.fillWithBlocks(p_74875_1_, p_74875_3_,
						...
						Blocks.iron_block, Blocks.air, false);
				this.fillWithBlocks(p_74875_1_, p_74875_3_,
						this.boundingBox.minX + 1, this.boundingBox.minY,
				...
				for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i) {
					for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j) {
						if (this.getBlockAtCurrentPosition(p_74875_1_, i,
								this.boundingBox.minY - 1, j, p_74875_3_)
	...
	public static class Room extends StructureComponent {
		...
		public Room(int p_i2037_1_, Random p_i2037_2_, int p_i2037_3_,
				int p_i2037_4_) {
			super(p_i2037_1_);
			this.boundingBox = new StructureBoundingBox(p_i2037_3_, 50,
					p_i2037_4_, p_i2037_3_ + 7 + p_i2037_2_.nextInt(6),
		...
		public void buildComponent(StructureComponent p_74861_1_,
			...
			for (j = 0; j < this.boundingBox.getXSize(); j += 4) {
				...
				structurecomponent1 = StructureIronMinePieces
						.getNextIronMineComponent(p_74861_1_, p_74861_2_,
								p_74861_3_, this.boundingBox.minX + j,
								this.boundingBox.minY + p_74861_3_.nextInt(k)
										+ 1, this.boundingBox.minZ - 1, 2, i);
				...
				if (structurecomponent1 != null) {
					...
					this.roomsLinkedToTheRoom.add(new StructureBoundingBox(
							...
							structureboundingbox.minY, this.boundingBox.minZ,
			...
			for (j = 0; j < this.boundingBox.getZSize(); j += 4) {
				...
				structurecomponent1 = StructureIronMinePieces
						.getNextIronMineComponent(p_74861_1_, p_74861_2_,
								p_74861_3_, this.boundingBox.minX - 1,
								this.boundingBox.minY + p_74861_3_.nextInt(k)
										+ 1, this.boundingBox.minZ + j, 1, i);

				if (structurecomponent1 != null) {
					structureboundingbox = structurecomponent1.getBoundingBox();
					this.roomsLinkedToTheRoom.add(new StructureBoundingBox(
							this.boundingBox.minX, structureboundingbox.minY,
			...
			for (j = 0; j < this.boundingBox.getZSize(); j += 4) {
				...
				structurecomponent1 = StructureIronMinePieces
						.getNextIronMineComponent(p_74861_1_, p_74861_2_,
								p_74861_3_, this.boundingBox.maxX + 1,
								this.boundingBox.minY + p_74861_3_.nextInt(k)
										+ 1, this.boundingBox.minZ + j, 3, i);
				...
				if (structurecomponent1 != null) {
					...
					this.roomsLinkedToTheRoom.add(new StructureBoundingBox(
							this.boundingBox.maxX - 1,
							structureboundingbox.minY,
							structureboundingbox.minZ, this.boundingBox.maxX,
							structureboundingbox.maxY,
							structureboundingbox.maxZ));
				}
			}
		...
		public boolean addComponentParts(World p_74875_1_, Random p_74875_2_,
			...
			if (this.isLiquidInStructureBoundingBox(p_74875_1_, p_74875_3_)) {
				...
				this.fillWithBlocks(p_74875_1_, p_74875_3_,
						...
						Blocks.obsidian, Blocks.air, true);
				this.fillWithBlocks(p_74875_1_, p_74875_3_,
						this.boundingBox.minX, this.boundingBox.minY + 1,
				...
				while (iterator.hasNext()) {
					StructureBoundingBox structureboundingbox1 = (StructureBoundingBox) iterator
							.next();
					this.fillWithBlocks(p_74875_1_, p_74875_3_,
							structureboundingbox1.minX,
							structureboundingbox1.maxY - 2,
							structureboundingbox1.minZ,
							structureboundingbox1.maxX,
							structureboundingbox1.maxY,
							structureboundingbox1.maxZ, Blocks.air, Blocks.air,
							false);
				}

				this.func_151547_a(p_74875_1_, p_74875_3_,
		...
		protected void func_143012_a(NBTTagCompound p_143012_1_) {
			...
			while (iterator.hasNext()) {
				StructureBoundingBox structureboundingbox = (StructureBoundingBox) iterator
						.next();
	...
	public static class Stairs extends StructureComponent {
		...
		public Stairs(int p_i2038_1_, Random p_i2038_2_,
			...
			this.hasRails = p_i2038_2_.nextInt(4) != 0;
		}
		...
		public static StructureBoundingBox findValidPlacement(List p_74950_0_,
			...
			return StructureComponent.findIntersecting(p_74950_0_,
					structureboundingbox) != null ? null : structureboundingbox;
		}
		...
		public void buildComponent(StructureComponent p_74861_1_,
			...
			case 0:
				StructureIronMinePieces.getNextIronMineComponent(p_74861_1_,
						p_74861_2_, p_74861_3_, this.boundingBox.minX,
						this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, i);
				break;
			case 1:
				StructureIronMinePieces.getNextIronMineComponent(p_74861_1_,
		...
		public boolean addComponentParts(World p_74875_1_, Random p_74875_2_,
			...
			if (this.isLiquidInStructureBoundingBox(p_74875_1_, p_74875_3_)) {
				...
				this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 5, 0, 2, 7, 1,
						Blocks.air, Blocks.air, false);
				this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 0, 7, 2, 2, 8,
						Blocks.air, Blocks.air, false);
				...
				for (i = 0; i < 4; ++i) {
					for (j1 = 0; j1 < 3; ++j1) {
						Block block1 = this.getBlockAtCurrentPosition(
								p_74875_1_, j1, (i < 2 ? 4 : -1), i
										+ (i < 2 ? 0 : 5), p_74875_3_);

						if (block1.getMaterial() == Material.air) {
							this.placeBlockAtCurrentPosition(p_74875_1_,
									Blocks.obsidian, 0, j1, (i < 2 ? 4 : -1), i
											+ (i < 2 ? 0 : 5), p_74875_3_);
						}
					}

					this.func_151552_a(p_74875_1_, p_74875_3_, p_74875_2_,
							0.7F, 1, (i < 2 ? 5 : 0), i + (i < 2 ? 0 : 5),
							Blocks.rail,
							this.getMetadataWithOffset(Blocks.rail, 0));
				}

				for (i = 0; i < 5; ++i) {
					this.fillWithBlocks(p_74875_1_, p_74875_3_, 0, 5 - i
							- (i < 4 ? 1 : 0), 2 + i, 2, 7 - i, 2 + i,
							Blocks.air, Blocks.air, false);

					for (j1 = 0; j1 < 3; ++j1) {
						Block block1 = this.getBlockAtCurrentPosition(
								p_74875_1_, j1, 4 - i - (i < 4 ? 1 : 0), 2 + i,
								p_74875_3_);

						if (block1.getMaterial() == Material.air) {
							this.placeBlockAtCurrentPosition(p_74875_1_,
									Blocks.obsidian, 0, j1, 4 - i
											- (i < 4 ? 1 : 0), 2 + i,
									p_74875_3_);
						}
					}
